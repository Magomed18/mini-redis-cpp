...
Redis-подобный сервер, реализованный на C++ для Windows. Проект демонстрирует работу с TCP-сетями, многопоточностью, персистентностью данных, управлением ресурсами и автоматизированным тестированием.

Сервер реализует ограниченный набор команд Redis и частичную совместимость с RESP2. Это учебный портфолио-проект.
